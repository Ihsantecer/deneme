...
public class C05_ObjectVariables {
        ...
        public static void main(String[] args) {
            ...
            C03_ObjectVariables pers4= new C03_ObjectVariables();
            pers4.persIsmi="alican";
            pers4.persYasi=22;
            pers4.persTelefonu="5534567278";

            System.out.println(pers4.persIsmi);
            System.out.println(pers4.persYasi);
            System.out.println(pers4.persTelefonu);
